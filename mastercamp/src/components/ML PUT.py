...
example_text = """The Serb was crowned for the third time in his career after 2016 and 2021, on the Parisian clay, on Sunday.
...
encoded_summary = pegasus_model.generate(**tokens, max_new_tokens=700)  # Use max_new_tokens instead of max_length
...
summary = summarizer(example_text, min_length=50, max_length=150, do_sample=True, temperature=1.5)
